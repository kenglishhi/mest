...
class Jobs::BlastRemoteTest < ActiveSupport::TestCase
  context "Blast databases against remote" do
    setup do
      ...
      @job =  Jobs::BlastRemote.new("Blasting Remote #{@test_biodatabase.name}",
